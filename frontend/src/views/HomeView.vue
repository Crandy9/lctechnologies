                ...
                <div class="page-contact">
                  ...
                  <div class="columns is-multiline">
                      <div class="column is-12 box">
                        <h2 style= "text-align: center;" class="form-sub subtitle has-text-black has-text-center is-underlined">{{$t('contactmodal.paymentdetails')}}</h2>
                        <h2 class="subtitle has-text-black">{{$t('contactmodal.billingaddress')}}</h2>
